...
{
    public struct FlatHexagonGridGenerator : IMeshGenerator
    {
        ...
        public MeshJobScheduleDelegate DefaultJobHandle => MeshJob<FlatHexagonGridGenerator, MultiStream>.ScheduleParallel;
