...
namespace ProceduralMeshes.Generators
{
    ...
    public struct SharedCubeSphereGenerator : IMeshGenerator
    {
        ...
        public MeshJobScheduleDelegate DefaultJobHandle => MeshJob<SharedCubeSphereGenerator, PositionStream>.ScheduleParallel;
        ...
        private static Side GetSide(int id) => id switch
        {
            ...
            _ => throw new System.Exception("Cube has 6 sides indexed from 0 to 5")
        };
