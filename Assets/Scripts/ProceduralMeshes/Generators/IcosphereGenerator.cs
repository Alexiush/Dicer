...
namespace ProceduralMeshes.Generators
{
    ...
    public struct IcosphereGenerator : IMeshGenerator
    {
        ...
        public MeshJobScheduleDelegate DefaultJobHandle => MeshJob<IcosphereGenerator, PositionStream>.ScheduleParallel;
