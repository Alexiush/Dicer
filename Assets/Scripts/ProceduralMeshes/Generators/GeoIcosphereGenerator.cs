...
namespace ProceduralMeshes.Generators
{
    ...
    public struct GeoIcosphereGenerator : IMeshGenerator
    {
        public int VertexCount => 5 * Resolution * ResolutionV + 2;
        public int IndexCount => 6 * 5 * Resolution * ResolutionV;
        public int JobLength => 5 * Resolution;
        public Bounds Bounds => new Bounds(Vector3.zero, new Vector3(2f, 2f, 2f));
        public int Resolution { get; set; }
        private int ResolutionV => 2 * Resolution;

        public MeshJobScheduleDelegate DefaultJobHandle => MeshJob<GeoIcosphereGenerator, PositionStream>.ScheduleParallel;
        ...
        private static Strip GetStrip(int id) => id switch
        {
            ...
            3 => CreateStrip(3),
            4 => CreateStrip(4),
            _ => throw new System.Exception("Icosphere has 5 strips indexed from 0 to 4")
        };
