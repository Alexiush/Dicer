...
namespace ProceduralMeshes.Generators
{
    ...
    public struct GeoOctasphereGenerator : IMeshGenerator
    {
        ...
        public MeshJobScheduleDelegate DefaultJobHandle => MeshJob<GeoOctasphereGenerator, MultiStream>.ScheduleParallel;
        ...
        private static Rhombus GetRhombus(int id) => id switch
        {
            ...
            _ => throw new System.Exception("Octasphere has 4 rhombus' indexed from 0 to 4")
        };
