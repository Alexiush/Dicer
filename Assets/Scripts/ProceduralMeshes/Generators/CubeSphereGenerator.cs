...
namespace ProceduralMeshes.Generators
{
    ...
    public struct CubeSphereGenerator : IMeshGenerator
    {
        ...
        public MeshJobScheduleDelegate DefaultJobHandle => MeshJob<CubeSphereGenerator, MultiStream>.ScheduleParallel;
